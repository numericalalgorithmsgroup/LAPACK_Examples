    Program zpptrf_example

!     ZPPTRF Example Program Text
...
!     .. Use Statements ..
      ...
      Use lapack_interfaces, Only: zpptrf
...
!     .. Executable Statements ..
      Write (nout, *) 'ZPPTRF Example Program Results'
...
!              =0 for hard exit, =1 for quiet-soft, =-1 for noisy-soft
        ...
        Call nagf_file_print_matrix_complex_packed_comp(uplo, 'Nonunit', n, &
          ap, 'Bracketed', 'F7.4', 'Factor', 'Integer', rlabs, 'Integer', &
          clabs, 80, 0, ifail)
