    Program zhpsvx_example

!     ZHPSVX Example Program Text

!     Copyright 2017, Numerical Algorithms Group Ltd. http://www.nag.com

!     .. Use Statements ..
      Use lapack_example_aux, Only: nagf_file_print_matrix_complex_gen_comp
      Use lapack_interfaces, Only: zhpsvx
...
!     .. Executable Statements ..
      Write (nout, *) 'ZHPSVX Example Program Results'
      Write (nout, *)
      Flush (nout)
...
!     Solve the equations AX = B for X
      Call zhpsvx('Not factored', uplo, n, nrhs, ap, afp, ipiv, b, ldb, x, &
