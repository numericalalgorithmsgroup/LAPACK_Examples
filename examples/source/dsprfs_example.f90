    Program dsprfs_example

!     DSPRFS Example Program Text

!     Copyright 2017, Numerical Algorithms Group Ltd. http://www.nag.com

!     .. Use Statements ..
      Use lapack_example_aux, Only: nagf_file_print_matrix_real_gen
      Use lapack_interfaces, Only: dsprfs, dsptrf, dsptrs
...
!     .. Local Scalars ..
      Integer :: i, ifail, info, j, ldb, ldx, len, n, nrhs
      Character (1) :: uplo
!     .. Local Arrays ..
...
!     Skip heading in data file
      ...
      ldx = n
      len = n*(n+1)/2
      Allocate (afp(len), ap(len), b(ldb,nrhs), berr(nrhs), ferr(nrhs), &
