    Subroutine x04dafn(matrix, diag, m, n, a, lda, title, nout, errbuf, ifail)
!     Mark 14 Release. NAG Copyright 1989.
!     Prints a general complex matrix.
!     Easy to use driver for X04DBFN.

!     .. Use Statements ..
      Use lapack_example_aux, Only: p01abf, x04dbfn
      Use lapack_precision, Only: dp
!     .. Implicit None Statement ..
      Implicit None
!     .. Parameters ..
      Character (6), Parameter :: srname = 'X04DAF'
!     .. Scalar Arguments ..
...
!
      ifdbf = 0
      Call x04dbfn(matrix, diag, m, n, a, lda, 'Above', ' ', title, 'I', &
        rlabs, 'I', clabs, 80, 0, nout, errbuf, ifdbf)
!
100   Continue
