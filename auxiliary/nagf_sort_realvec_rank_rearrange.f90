...
!
!     NAGF_SORT_REALVEC_RANK_REARRANGE is designed to be used typically in
!     conjunction with the M01D- ranking routines. After One Of The M01D-
!     routines has been called to determine a vector of ranks,
!     NAGF_SORT_REALVEC_RANK_REARRANGE can be called to re-arrange a vector of
!     real numbers into the rank order. If the vector of ranks has been
!     generated in some other way, Then M01ZBF should be called to check
!      its validity before NAGF_SORT_REALVEC_RANK_REARRANGE is called.
!
